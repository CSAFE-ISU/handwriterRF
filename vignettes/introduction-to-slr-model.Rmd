...
3. Calculate the proportion of graphs assigned to each cluster with `get_cluster_fill_rates()`. The cluster fill rates serve as an estimate of the writer profile for the sample.
...
```{r profiles-combined}
handwriter::plot_writer_profiles(wps, color_by = "writer")
```
