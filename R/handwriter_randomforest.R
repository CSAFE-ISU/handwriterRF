...
importance(rf1)
plot(rf1)
varimportanceplot<-varImpPlot(rf1, main="Variable Importance in Random Forest");varimportanceplot
...
importance(rf2)
plot(rf2)
varimportanceplot<-varImpPlot(rf2, main="Variable Importance in Random Forest");varimportanceplot
